...
let quadratic (x1 : int) (x2 : int) : int * int * int =
  (1, -x1 - x2, x1 * x2)

let%test _ = quadratic 1 2 = (1, -3, 2)
let%test _ = quadratic 0 1 = (1, -1, 0)
let%test _ = quadratic 0 0 = (1, 0, 0)
let%test _ = quadratic 4 9 = (1, -13, 36)
let%test _ = quadratic ~-5 ~-4 = (1, 9, 20)
